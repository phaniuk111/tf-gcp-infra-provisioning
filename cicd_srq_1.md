sequenceDiagram
    ...
    Note over Dev: WLTS Integration When Ready (Via Flags on Main, Auto-Deploy from Main)
    Note over Dev: For New WLTS Features Post-Hotfix: Rebase Required Before PR
